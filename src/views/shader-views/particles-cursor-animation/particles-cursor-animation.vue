...
onMounted(() => {
  ...
  particlesGeometry.setAttribute("aRandomness", new THREE.Float32BufferAttribute(randomnessArray, 1));
  ...
  world.run(() => {
    ...
    ctx2d.drawImage(image, canvasCursor.x - glowSize / 2, canvasCursor.y - glowSize / 2, glowSize, glowSize);
