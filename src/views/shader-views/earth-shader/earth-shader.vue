...
const earthMaterial = new THREE.ShaderMaterial({
  ...
  uniforms: {
    ...
    uAtmosphereTwilightColor: new THREE.Uniform(new THREE.Color(earthParameter.atmosphereTwilightColor)),
  },
});
...
onMounted(() => {
  ...
  gui.addColor(earthParameter, "atmosphereTwilightColor").onChange(() => {
    earthMaterial.uniforms.uAtmosphereTwilightColor.value.set(earthParameter.atmosphereTwilightColor);
    atmosphereMaterial.uniforms.uAtmosphereTwilightColor.value.set(earthParameter.atmosphereTwilightColor);
  });
